...
public:
                     ...
                     prev_r_ecd_(0)
    {
        ...
        auto qos = rclcpp::QoS(rclcpp::KeepLast(loop_rate_))
            .durability_volatile()  // This sets the Durability QoS to "VOLATILE"
            .reliable();             // This sets the Reliability QoS to "RELIABLE"
